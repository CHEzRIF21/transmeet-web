    ...
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
      <div className="space-y-3">
        ...
        <h1 className="text-balance text-2xl font-semibold tracking-tight sm:text-3xl">
          Transmeet, plateforme digitale de logistique lourde
        </h1>
      </div>
      <div className="mt-6 space-y-4 text-base text-muted-foreground sm:text-lg">
        <p>
          ...
          BTP. Nous combinons expertise terrain et innovation technologique pour
          offrir des solutions logistiques fiables, structurées et adaptées aux
